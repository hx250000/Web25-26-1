package com.zjgsu.hx.aichatbackend;
...
class AiChatBackendApplicationTests {
	...
	void setUp() {
		...
		service = ArkService.builder().dispatcher(dispatcher).connectionPool(connectionPool).baseUrl("https://ark.cn-beijing.volces.com/api/v3/").apiKey(apiKey).build();
	}
